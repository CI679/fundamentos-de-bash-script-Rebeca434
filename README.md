...
Este proyecto se encuentra alojado en **GitHub Classroom**. Puedes acceder al repositorio [aquí]([URL_DEL_REPOSITORIO>](https://github.com/CI679/fundamentos-de-bash-script-Rebeca434/blob/main/README.md)).
