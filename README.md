...
```bash
git clone https://github.com/CI679/fundamentos-de-bash-script-Rebeca434
cd bash_scripting
```
...
Este proyecto se encuentra alojado en **GitHub Classroom**. Puedes acceder al repositorio [aquí](https://github.com/CI679/fundamentos-de-bash-script-Rebeca434)
